package com.umr.myhrm_common_model.domain.employee.response;
...
public class EmployeeReportResult {
    ...
    public EmployeeReportResult(UserCompanyPerson personal, EmployeeResignation resignation) throws InvocationTargetException, IllegalAccessException {
        BeanUtils.copyProperties(this, personal);
        if(resignation != null) {
            BeanUtils.copyProperties(this,resignation);
        }
    }
}
